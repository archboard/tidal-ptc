...
const dismissColors = {
  ...
  neutral: 'bg-gray-50 dark:bg-gray-900 text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-900 focus:ring-offset-gray-50 dark:focus:ring-offset-gray-800 focus:ring-gray-600',
