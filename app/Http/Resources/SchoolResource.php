...
class SchoolResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'open_for_contacts_at' => $this->resource->open_for_contacts_at,
            'close_for_contacts_at' => $this->resource->close_for_contacts_at,
            'open_for_teachers_at' => $this->resource->open_for_teachers_at,
            'close_for_teachers_at' => $this->resource->close_for_teachers_at,
